...
const ViewBiohazard = () => {
  ...
  const handleAddBiohazard = () => {
    ...
    console.log(addBiohazardPayload)
    handleClose()
  }
  ...
  return (
    <>
      ...
      <Dialog open={open} onClose={handleClose} aria-labelledby='form-dialog-title'>
        <DialogTitle id='form-dialog-title'> Add Biohazard Dispose</DialogTitle>
        ...
        <DialogActions className='dialog-actions-dense' sx={{ m: 4 }}>
          <Button onClick={handleAddBiohazard} variant='contained'>
            Add
          </Button>
