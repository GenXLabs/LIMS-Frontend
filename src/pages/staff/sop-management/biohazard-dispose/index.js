...
const ViewBiohazardDispose = () => {
  ...
  const handleAddBiohazardDispose = () => {
    ...
    formData.append('manual', new Blob([JSON.stringify(addBiohazardPayload)], { type: 'application/json' }))
  ...
  const handlePrint = () => {
    ...
    doc.text('BIOHAZARD DISPOSE REPORT.', 14, 15)
  ...
  return (
    <>
      ...
      <Dialog open={open} onClose={handleClose} aria-labelledby='form-dialog-title'>
        <DialogTitle id='form-dialog-title'>Add Biohazard Disposes</DialogTitle>
        ...
        <DialogActions className='dialog-actions-dense' sx={{ m: 4 }}>
          <Button onClick={handleAddBiohazardDispose} variant='contained'>
            Add
          </Button>
...
export default ViewBiohazardDispose
